...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    steelMan: "Steel Man",
    socraticFormat: "Socratic",
    debateDifficulty: "Difficulty",
    casualMode: "Casual",
    competitiveMode: "Competitive",
    academicMode: "Academic",
    roundCount: "Rounds",
    evidenceBtn: "Cite Evidence",
    rebuttalsBtn: "Rebuttal Coach",
    logic: "Logic",
    persuasiveness: "Persuasiveness",
    relevance: "Relevance",
    strongestArg: "Your Strongest Argument",
    weakestArg: "Your Weakest Argument",
    whatOpponentSaid: "What the Other Side Could Have Said",
    finalVerdict: "Final Verdict",
    winVerdict: "You Won!",
    drawVerdict: "It's a Draw",
    lossVerdict: "You Lost",
    writingMode: "Writing Mode",
    collaborativeMode: "Collaborative",
    soloMode: "Solo",
    guidedMode: "Guided",
    storyLength: "Story Length",
    shortStory: "Short (3 chapters)",
    mediumStory: "Medium (5 chapters)",
    epicStory: "Epic (8 chapters)",
    writingFocus: "Writing Focus (Optional)",
    descriptiveFocus: "Descriptive Language",
    dialogueFocus: "Dialogue",
    plotTwistFocus: "Plot Twists",
    characterFocus: "Character Development",
    branchChoicePrompt: "Choose what happens next:",
    suggestionLabel: "Writing Suggestion",
    acceptSuggestion: "Accept",
    bestSentence: "Your Best Sentence",
    vocabularyElevate: "Vocabulary to Elevate",
    readingLevel: "Reading Level",
    caseDifficulty: "Case Difficulty",
    rookieCase: "Rookie (SELECT)",
    detectiveCase: "Detective (JOINs)",
    inspectorCase: "Inspector (Subqueries)",
    chiefCase: "Chief (Window Functions)",
    caseTheme: "Case Theme",
    crimeTheme: "Crime",
    corporateTheme: "Corporate Espionage",
    archaeologicalTheme: "Archaeological Discovery",
    medicalTheme: "Medical Mystery",
    evidenceLog: "Evidence Log",
    queryExplainer: "Explain Query",
    optimalSolution: "Optimal Solution",
    efficiencyScore: "Efficiency Score",
    newCase: "New Case",
    flashcardBlitz: "Flashcard Blitz",
    flashcardBlitzDesc: "Master 15 AI-generated flashcards with spaced repetition. Know it or don't!",
    wordScramblePlus: "Word Scramble+",
    wordScramblePlusDesc: "Three modes: unscramble, fill blanks, and anagram. Words from your subject!",
    bugHunt: "Bug Hunt",
    bugHuntDesc: "Find and fix 3 hidden bugs in real code. Hot/warm/cold feedback guides you.",
    conceptConnector: "Concept Connector",
    conceptConnectorDesc: "Connect 8 concepts with labeled relationship arrows and justify each link.",
    trueFalse: "True/False Rapid Fire",
    trueFalseDesc: "20 statements, 10 seconds each. Build a combo streak for bonus XP!",
    pictureThis: "Picture This",
    pictureThisDesc: "Identify the concept from 4 descriptions. Visual thinking at its finest.",
    ...
    requires: "requires",
    opposes: "opposes",
    isTypeOf: "is a type of",
    justifyConnection: "Why are these connected?",
    comboBonus: "Combo ×",
    cardsDeck: "cards",
    timedMode: "Timed",
    relaxedMode: "Relaxed",
    ...
    warmFeedback: "Warm 🔥",
    hotFeedback: "Hot 🔥🔥",
    fixItMode: "Fix It Mode",
    slideCount: "Number of Slides",
    audiencePicker: "Audience",
    audienceClass: "My Class",
    audienceTeacher: "Teacher",
    audienceParents: "Parents",
    audienceCompetition: "Competition",
    structureType: "Structure",
    informativeStructure: "Informative",
    persuasiveStructure: "Persuasive",
    howToStructure: "How-To",
    compareContrastStructure: "Compare & Contrast",
    timelineStructure: "Timeline",
    visualTheme: "Visual Theme",
    editSlide: "Edit Slide",
    regenerateSlide: "Regenerate",
    makeSimpler: "Simpler",
    moreDetailed: "More Detail",
    addSlide: "Add Slide",
    deleteSlide: "Delete Slide",
    exportPptx: "Download PPTX",
    presenterTimer: "Presenting",
    generatingSlide: "Generating slide",
    includes: "Include",
    dailyGoal: "Daily goal",
    dailyGoalDesc: "Choose how much XP to earn each day",
    goalMet: "Daily goal complete!",
    goalMetDesc: "You hit today's goal — streak secured.",
    todayProgress: "Today's progress",
    xpToGo: (n: number) => `${n} XP to go`,
    setGoal: "Set daily goal",
    streakSaved: "Streak saved!",
    freezeUsed: "A streak freeze kept your streak alive.",
    freezesLeft: (n: number) => `${n} streak freeze${n === 1 ? '' : 's'} left`,
    achievements: "Achievements",
    achievementsDesc: "Collect badges as you learn.",
    achievementUnlocked: "Achievement unlocked!",
    nextUp: "Next up",
    unlocked: (n: number, total: number) => `${n} of ${total} unlocked`,
    leaderboard: "Leaderboard",
    leaderboardDesc: "See how you rank against other learners.",
    rank: "Rank",
    you: "You",
    yourRank: (n: number) => `You're ranked #${n}`,
    noRankYet: "No rankings yet — earn some XP to appear here.",
    ...
    buildingPractice: "Building practice problems…",
    easierOne: "Let's try an easier one first",
    practiceComplete: "Practice complete",
    practiceScore: (c, t) => `${c} of ${t} correct`,
    practiceEncouragement: "Every attempt strengthens the skill — that's how it sticks.",
    practiceNext: "Next",
    practiceCheck: "Check",
  },
  ru: {
    ...
    passedTests: "Тесты пройдены",
    failedTests: "Тесты не пройдены",
    allTestsPassed: "Все тесты пройдены!",
    explainError: "Объяснить ошибку",
    codeReview: "Проверка кода",
    conceptTags: "Концепции",
    difficultyTier: "Сложность",
    nextChallenge: "Следующее задание",
    hintsRemaining: "подсказок осталось",
    getHint: "Подсказка",
    debateFormat: "Формат дебатов",
    classicFormat: "Классика",
    devilsAdvocate: "Адвокат дьявола",
    steelMan: "Стальной человек",
    socraticFormat: "Сократовский",
    debateDifficulty: "Сложность",
    casualMode: "Обычный",
    competitiveMode: "Соревновательный",
    academicMode: "Академический",
    roundCount: "Раунды",
    evidenceBtn: "Привести доказательства",
    rebuttalsBtn: "Тренер по репликам",
    logic: "Логика",
    persuasiveness: "Убедительность",
    relevance: "Релевантность",
    strongestArg: "Ваш сильнейший аргумент",
    weakestArg: "Ваш слабейший аргумент",
    whatOpponentSaid: "Что мог сказать оппонент",
    finalVerdict: "Итоговый вердикт",
    winVerdict: "Вы победили!",
    drawVerdict: "Ничья",
    lossVerdict: "Вы проиграли",
    writingMode: "Режим написания",
    collaborativeMode: "Совместный",
    soloMode: "Соло",
    guidedMode: "С подсказками",
    storyLength: "Длина истории",
    shortStory: "Короткая (3 главы)",
    mediumStory: "Средняя (5 глав)",
    epicStory: "Эпическая (8 глав)",
    writingFocus: "Фокус написания (по желанию)",
    descriptiveFocus: "Описательный язык",
    dialogueFocus: "Диалог",
    plotTwistFocus: "Сюжетные повороты",
    characterFocus: "Развитие персонажа",
    branchChoicePrompt: "Выберите, что будет дальше:",
    suggestionLabel: "Совет по написанию",
    acceptSuggestion: "Принять",
    bestSentence: "Ваше лучшее предложение",
    vocabularyElevate: "Словарь для улучшения",
    readingLevel: "Уровень чтения",
    caseDifficulty: "Сложность дела",
    rookieCase: "Новичок (SELECT)",
    detectiveCase: "Детектив (JOINs)",
    inspectorCase: "Инспектор (подзапросы)",
    chiefCase: "Шеф (оконные функции)",
    caseTheme: "Тема дела",
    crimeTheme: "Преступление",
    corporateTheme: "Корпоративный шпионаж",
    archaeologicalTheme: "Археологические находки",
    medicalTheme: "Медицинская тайна",
    evidenceLog: "Журнал улик",
    queryExplainer: "Объяснить запрос",
    optimalSolution: "Оптимальное решение",
    efficiencyScore: "Оценка эффективности",
    newCase: "Новое дело",
    flashcardBlitz: "Флэш-карточки",
    flashcardBlitzDesc: "Освойте 15 карточек с интервальными повторениями. Знаешь или нет!",
    wordScramblePlus: "Сборка слов+",
    wordScramblePlusDesc: "Три режима: разгадай анаграмму, вставь буквы, найди все слова.",
    bugHunt: "Охота за багами",
    bugHuntDesc: "Найдите и исправьте 3 скрытых бага в реальном коде. Горячо/тепло/холодно!",
    conceptConnector: "Связи понятий",
    conceptConnectorDesc: "Соедините 8 понятий связями с подписями и объясните каждую.",
    trueFalse: "Правда/Ложь: Рапид",
    trueFalseDesc: "20 утверждений, 10 секунд на каждое. Серия правильных ответов = бонус XP!",
    pictureThis: "Угадай картинку",
    pictureThisDesc: "Определите понятие из 4 описаний. Визуальное мышление в лучшем виде.",
    dailyChallenge: "Ежедневный вызов",
    highScore: "Рекорд",
    knowIt: "Знаю ✓",
    dontKnow: "Не знаю ✗",
    connectConcepts: "Соединить понятия",
    selectRelationship: "Выбрать связь",
    causes: "вызывает",
    requires: "требует",
    opposes: "противоречит",
    isTypeOf: "является видом",
    justifyConnection: "Почему они связаны?",
    comboBonus: "Комбо ×",
    cardsDeck: "карточек",
    timedMode: "На время",
    relaxedMode: "Расслабленный",
    coldFeedback: "Холодно ❄️",
    warmFeedback: "Тепло 🔥",
    hotFeedback: "Горячо 🔥🔥",
    fixItMode: "Режим исправления",
    slideCount: "Количество слайдов",
    audiencePicker: "Аудитория",
    audienceClass: "Мой класс",
    audienceTeacher: "Учитель",
    audienceParents: "Родители",
    audienceCompetition: "Конкурс",
    structureType: "Структура",
    informativeStructure: "Информационная",
    persuasiveStructure: "Убеждающая",
    howToStructure: "Инструкция",
    compareContrastStructure: "Сравнение",
    timelineStructure: "Хронология",
    visualTheme: "Визуальная тема",
    editSlide: "Редактировать",
    regenerateSlide: "Перегенерировать",
    makeSimpler: "Упростить",
    moreDetailed: "Подробнее",
    addSlide: "Добавить слайд",
    deleteSlide: "Удалить слайд",
    exportPptx: "Скачать PPTX",
    presenterTimer: "Презентация",
    generatingSlide: "Генерация слайда",
    includes: "Включить",
    dailyGoal: "Дневная цель",
    dailyGoalDesc: "Выбери, сколько XP набирать каждый день",
    goalMet: "Дневная цель выполнена!",
    goalMetDesc: "Ты выполнил цель дня — серия сохранена.",
    todayProgress: "Прогресс за сегодня",
    xpToGo: (n: number) => `Осталось ${n} XP`,
    setGoal: "Задать цель",
    streakSaved: "Серия сохранена!",
    freezeUsed: "Заморозка серии сохранила твой прогресс.",
    freezesLeft: (n: number) => `Осталось заморозок: ${n}`,
    achievements: "Достижения",
    achievementsDesc: "Собирай значки во время учёбы.",
    achievementUnlocked: "Достижение получено!",
    nextUp: "Далее",
    unlocked: (n: number, total: number) => `Открыто ${n} из ${total}`,
    leaderboard: "Таблица лидеров",
    leaderboardDesc: "Посмотри своё место среди других учеников.",
    rank: "Место",
    you: "Ты",
    yourRank: (n: number) => `Твоё место — №${n}`,
    noRankYet: "Пока нет рейтинга — набери XP, чтобы появиться здесь.",
    loadingBoard: "Загрузка таблицы…",
    ...
    practiceThis: "Потренироваться",
    buildingPractice: "Готовим задачи для практики…",
    easierOne: "Сначала попробуем полегче",
    practiceComplete: "Практика завершена",
    practiceScore: (c, t) => `${c} из ${t} верно`,
    practiceEncouragement: "Каждая попытка укрепляет навык — так он и закрепляется.",
    practiceNext: "Далее",
  ...
  he: {
    ...
    submitSolution: "שלח פתרון",
    testResults: "תוצאות בדיקה",
    passedTests: "בדיקות עברו",
    failedTests: "בדיקות נכשלו",
    allTestsPassed: "כל הבדיקות עברו!",
    explainError: "הסבר שגיאה",
    codeReview: "סקירת קוד",
    conceptTags: "מושגים",
    difficultyTier: "רמת קושי",
    nextChallenge: "האתגר הבא",
    hintsRemaining: "רמזים נותרו",
    getHint: "קבל רמז",
    debateFormat: "פורמט ויכוח",
    classicFormat: "קלאסי",
    devilsAdvocate: "עורך דין של השטן",
    steelMan: "הטיעון החזק ביותר",
    socraticFormat: "סוקרטי",
    debateDifficulty: "רמת קושי",
    casualMode: "מזדמן",
    competitiveMode: "תחרותי",
    academicMode: "אקדמי",
    roundCount: "סיבובים",
    evidenceBtn: "הצג עדויות",
    rebuttalsBtn: "מאמן תגובות",
    logic: "לוגיקה",
    persuasiveness: "שכנוע",
    relevance: "רלוונטיות",
    strongestArg: "הטיעון החזק שלך",
    weakestArg: "הטיעון החלש שלך",
    whatOpponentSaid: "מה הצד השני יכול היה להגיד",
    finalVerdict: "פסק דין סופי",
    winVerdict: "ניצחת!",
    drawVerdict: "תיקו",
    lossVerdict: "הפסדת",
    writingMode: "מצב כתיבה",
    collaborativeMode: "שיתופי",
    soloMode: "סולו",
    guidedMode: "מונחה",
    storyLength: "אורך הסיפור",
    shortStory: "קצר (3 פרקים)",
    mediumStory: "בינוני (5 פרקים)",
    epicStory: "אפי (8 פרקים)",
    writingFocus: "מיקוד כתיבה (אופציונלי)",
    descriptiveFocus: "שפה תיאורית",
    dialogueFocus: "דיאלוג",
    plotTwistFocus: "פיתולי עלילה",
    characterFocus: "פיתוח דמויות",
    branchChoicePrompt: "בחר מה יקרה הלאה:",
    suggestionLabel: "הצעת כתיבה",
    acceptSuggestion: "קבל",
    bestSentence: "המשפט הטוב ביותר שלך",
    vocabularyElevate: "מילים לשיפור",
    readingLevel: "רמת קריאה",
    caseDifficulty: "רמת קושי התיק",
    rookieCase: "מתחיל (SELECT)",
    detectiveCase: "בלש (JOINs)",
    inspectorCase: "מפקח (תת-שאילתות)",
    chiefCase: "ראש (פונקציות חלון)",
    caseTheme: "נושא התיק",
    crimeTheme: "פשע",
    corporateTheme: "ריגול תאגידי",
    archaeologicalTheme: "גילוי ארכיאולוגי",
    medicalTheme: "תעלומה רפואית",
    evidenceLog: "יומן ראיות",
    queryExplainer: "הסבר שאילתה",
    optimalSolution: "פתרון אופטימלי",
    efficiencyScore: "ציון יעילות",
    newCase: "תיק חדש",
    flashcardBlitz: "כרטיסיות בליץ",
    flashcardBlitzDesc: "שלוט ב-15 כרטיסיות עם חזרות מרווחות. יודע או לא יודע!",
    wordScramblePlus: "סידור מילים+",
    wordScramblePlusDesc: "שלושה מצבים: פרק אנגרמה, מלא אותיות, מצא כל המילים.",
    bugHunt: "ציד באגים",
    bugHuntDesc: "מצא ותקן 3 באגים מוסתרים בקוד אמיתי. חם/פושר/קר מנחה אותך.",
    conceptConnector: "מחבר מושגים",
    conceptConnectorDesc: "חבר 8 מושגים עם חצים מסומנים והסבר כל קישור.",
    trueFalse: "נכון/לא נכון: ריפייר",
    trueFalseDesc: "20 טענות, 10 שניות לכל אחת. סדרת תשובות נכונות = XP בונוס!",
    pictureThis: "נחש את התמונה",
    pictureThisDesc: "זהה את המושג מ-4 תיאורים. חשיבה ויזואלית במיטבה.",
    dailyChallenge: "אתגר יומי",
    highScore: "שיא אישי",
    knowIt: "יודע ✓",
    dontKnow: "לא יודע ✗",
    connectConcepts: "חבר מושגים",
    selectRelationship: "בחר קשר",
    causes: "גורם ל",
    requires: "דורש",
    opposes: "מנוגד ל",
    isTypeOf: "הוא סוג של",
    justifyConnection: "למה הם קשורים?",
    comboBonus: "קומבו ×",
    cardsDeck: "כרטיסיות",
    timedMode: "על הזמן",
    relaxedMode: "רגוע",
    ...
    hotFeedback: "חם 🔥🔥",
    fixItMode: "מצב תיקון",
    slideCount: "מספר שקופיות",
    audiencePicker: "קהל",
    audienceClass: "הכיתה שלי",
    audienceTeacher: "מורה",
    audienceParents: "הורים",
    audienceCompetition: "תחרות",
    structureType: "מבנה",
    informativeStructure: "אינפורמטיבי",
    persuasiveStructure: "משכנע",
    howToStructure: "הוראות",
    compareContrastStructure: "השוואה",
    timelineStructure: "ציר זמן",
    visualTheme: "ערכת צבעים",
    editSlide: "ערוך שקופית",
    regenerateSlide: "יצור מחדש",
    makeSimpler: "פשט",
    moreDetailed: "הרחב",
    addSlide: "הוסף שקופית",
    deleteSlide: "מחק שקופית",
    exportPptx: "הורד PPTX",
    presenterTimer: "מציג",
    generatingSlide: "יוצר שקופית",
    includes: "כלול",
    dailyGoal: "יעד יומי",
    dailyGoalDesc: "בחר כמה XP לצבור בכל יום",
    goalMet: "השלמת את היעד היומי!",
    goalMetDesc: "הגעת ליעד של היום — הרצף נשמר.",
    todayProgress: "ההתקדמות של היום",
    xpToGo: (n: number) => `נותרו ${n} XP`,
    setGoal: "הגדר יעד",
    streakSaved: "הרצף נשמר!",
    freezeUsed: "הקפאת רצף שמרה על הרצף שלך.",
    freezesLeft: (n: number) => `נותרו ${n} הקפאות רצף`,
    achievements: "הישגים",
    achievementsDesc: "אסוף תגים תוך כדי הלמידה.",
    achievementUnlocked: "הישג נפתח!",
    nextUp: "הבא בתור",
    unlocked: (n: number, total: number) => `${n} מתוך ${total} נפתחו`,
    leaderboard: "טבלת מובילים",
    leaderboardDesc: "ראה את הדירוג שלך מול לומדים אחרים.",
    rank: "דירוג",
    you: "אתה",
    yourRank: (n: number) => `הדירוג שלך: #${n}`,
    noRankYet: "אין עדיין דירוג — צבור XP כדי להופיע כאן.",
    loadingBoard: "טוען טבלה…",
    ...
    buildingPractice: "מכינים שאלות תרגול…",
    easierOne: "בוא ננסה קודם משהו קל יותר",
    practiceComplete: "התרגול הושלם",
    practiceScore: (c, t) => `${c} מתוך ${t} נכונות`,
    practiceEncouragement: "כל ניסיון מחזק את המיומנות — כך היא נטמעת.",
    practiceNext: "הבא",
    practiceCheck: "בדיקה",
  },
  ar: {
    ...
    passedTests: "اجتازت الاختبارات",
    failedTests: "فشلت الاختبارات",
    allTestsPassed: "اجتازت جميع الاختبارات!",
    explainError: "اشرح الخطأ",
    codeReview: "مراجعة الكود",
    conceptTags: "المفاهيم",
    difficultyTier: "مستوى الصعوبة",
    nextChallenge: "التحدي التالي",
    hintsRemaining: "تلميحات متبقية",
    getHint: "تلميح",
    debateFormat: "صيغة النقاش",
    classicFormat: "كلاسيكي",
    devilsAdvocate: "محامي الشيطان",
    steelMan: "أقوى حجة",
    socraticFormat: "سقراطي",
    debateDifficulty: "مستوى الصعوبة",
    casualMode: "عادي",
    competitiveMode: "تنافسي",
    academicMode: "أكاديمي",
    roundCount: "الجولات",
    evidenceBtn: "استشهد بأدلة",
    rebuttalsBtn: "مدرب الردود",
    logic: "المنطق",
    persuasiveness: "الإقناع",
    relevance: "الصلة بالموضوع",
    strongestArg: "أقوى حجة لديك",
    weakestArg: "أضعف حجة لديك",
    whatOpponentSaid: "ما كان يمكن أن يقوله الطرف الآخر",
    finalVerdict: "الحكم النهائي",
    winVerdict: "فزت!",
    drawVerdict: "تعادل",
    lossVerdict: "خسرت",
    writingMode: "وضع الكتابة",
    collaborativeMode: "تعاوني",
    soloMode: "منفرد",
    guidedMode: "موجّه",
    storyLength: "طول القصة",
    shortStory: "قصيرة (3 فصول)",
    mediumStory: "متوسطة (5 فصول)",
    epicStory: "ملحمية (8 فصول)",
    writingFocus: "محور الكتابة (اختياري)",
    descriptiveFocus: "اللغة الوصفية",
    dialogueFocus: "الحوار",
    plotTwistFocus: "منعطفات الحبكة",
    characterFocus: "تطوير الشخصيات",
    branchChoicePrompt: "اختر ما سيحدث بعد ذلك:",
    suggestionLabel: "اقتراح كتابي",
    acceptSuggestion: "قبول",
    bestSentence: "أفضل جملة كتبتها",
    vocabularyElevate: "مفردات للتطوير",
    readingLevel: "مستوى القراءة",
    caseDifficulty: "صعوبة القضية",
    rookieCase: "مبتدئ (SELECT)",
    detectiveCase: "محقق (JOINs)",
    inspectorCase: "مفتش (استعلامات فرعية)",
    chiefCase: "رئيس (دوال النافذة)",
    caseTheme: "موضوع القضية",
    crimeTheme: "جريمة",
    corporateTheme: "تجسس مؤسسي",
    archaeologicalTheme: "اكتشاف أثري",
    medicalTheme: "لغز طبي",
    evidenceLog: "سجل الأدلة",
    queryExplainer: "اشرح الاستعلام",
    optimalSolution: "الحل الأمثل",
    efficiencyScore: "درجة الكفاءة",
    newCase: "قضية جديدة",
    flashcardBlitz: "بطاقات تعليمية",
    flashcardBlitzDesc: "أتقن 15 بطاقة بالتكرار المتباعد. اعرف أم لا!",
    wordScramblePlus: "تنظيم الكلمات+",
    wordScramblePlusDesc: "ثلاثة أوضاع: فك التشابك، ملء الحروف، إيجاد كل الكلمات.",
    bugHunt: "صيد الأخطاء",
    bugHuntDesc: "ابحث عن 3 أخطاء مخفية في الكود الحقيقي واصلحها. ساخن/دافئ/بارد يرشدك.",
    conceptConnector: "رابط المفاهيم",
    conceptConnectorDesc: "ربط 8 مفاهيم بأسهم معنونة وتبرير كل رابط.",
    trueFalse: "صح/خطأ سريع",
    trueFalseDesc: "20 عبارة، 10 ثوانٍ لكل منها. سلسلة إجابات صحيحة = XP إضافي!",
    pictureThis: "خمّن الصورة",
    pictureThisDesc: "تعرف على المفهوم من 4 أوصاف. التفكير البصري في أبهى صوره.",
    dailyChallenge: "تحدي يومي",
    highScore: "أعلى نقاط",
    knowIt: "أعرفه ✓",
    dontKnow: "لا أعرف ✗",
    connectConcepts: "ربط المفاهيم",
    selectRelationship: "اختر العلاقة",
    causes: "يسبب",
    requires: "يتطلب",
    opposes: "يعارض",
    isTypeOf: "نوع من",
    justifyConnection: "لماذا هما مترابطان؟",
    comboBonus: "مضاعف ×",
    cardsDeck: "بطاقات",
    timedMode: "موقوت",
    relaxedMode: "مريح",
    ...
    warmFeedback: "دافئ 🔥",
    hotFeedback: "ساخن 🔥🔥",
    fixItMode: "وضع الإصلاح",
    slideCount: "عدد الشرائح",
    audiencePicker: "الجمهور",
    audienceClass: "فصلي",
    audienceTeacher: "المعلم",
    audienceParents: "أولياء الأمور",
    audienceCompetition: "مسابقة",
    structureType: "الهيكل",
    informativeStructure: "إعلامي",
    persuasiveStructure: "إقناعي",
    howToStructure: "كيفية",
    compareContrastStructure: "مقارنة",
    timelineStructure: "خط الزمن",
    visualTheme: "السمة البصرية",
    editSlide: "تعديل الشريحة",
    regenerateSlide: "إعادة توليد",
    makeSimpler: "تبسيط",
    moreDetailed: "مزيد من التفاصيل",
    addSlide: "إضافة شريحة",
    deleteSlide: "حذف الشريحة",
    exportPptx: "تنزيل PPTX",
    presenterTimer: "عرض تقديمي",
    generatingSlide: "جارٍ إنشاء الشريحة",
    includes: "تضمين",
    dailyGoal: "الهدف اليومي",
    dailyGoalDesc: "اختر كم نقطة خبرة تكسب كل يوم",
    goalMet: "اكتمل الهدف اليومي!",
    goalMetDesc: "حققت هدف اليوم — تم تأمين سلسلتك.",
    todayProgress: "تقدّم اليوم",
    xpToGo: (n: number) => `بقي ${n} نقطة خبرة`,
    setGoal: "حدد الهدف",
    streakSaved: "تم حفظ السلسلة!",
    freezeUsed: "حافظ تجميد السلسلة على استمرارها.",
    freezesLeft: (n: number) => `بقي ${n} من تجميدات السلسلة`,
    achievements: "الإنجازات",
    achievementsDesc: "اجمع الأوسمة أثناء تعلّمك.",
    achievementUnlocked: "تم فتح إنجاز!",
    nextUp: "التالي",
    unlocked: (n: number, total: number) => `${n} من ${total} مفتوحة`,
    leaderboard: "لوحة المتصدرين",
    leaderboardDesc: "شاهد ترتيبك بين المتعلمين الآخرين.",
    rank: "الترتيب",
    you: "أنت",
    yourRank: (n: number) => `ترتيبك رقم ${n}`,
    noRankYet: "لا توجد تصنيفات بعد — اكسب نقاط خبرة لتظهر هنا.",
    ...
    buildingPractice: "نُعِدّ أسئلة التدريب…",
    easierOne: "لنجرّب سؤالاً أسهل أولاً",
    practiceComplete: "اكتمل التدريب",
    practiceScore: (c, t) => `${c} من ${t} صحيحة`,
    practiceEncouragement: "كل محاولة تقوّي المهارة — هكذا ترسخ.",
    practiceNext: "التالي",
    practiceCheck: "تحقق",
  }
};
