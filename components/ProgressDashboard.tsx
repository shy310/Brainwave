                  ...
                  {weakTopics.map(topic => (
                    <li key={topic.topicId} className="flex items-center gap-3 p-3 rounded-xl hover:bg-cream-50 dark:hover:bg-ink-800/60 transition-colors">
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg bg-moss-50 dark:bg-moss-light/20 text-moss-600 dark:text-moss-400 hover:bg-moss-100 transition-all duration-150 flex-shrink-0"
              ...
              {subjectMastery.map(({ subject, mastery, attempted, total }) => {
                ...
                return (
                  <div key={subject} className="flex items-center gap-6">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${subjectData?.color || 'bg-cream-50'}`}>
